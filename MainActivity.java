...
import com.wangwanfeng.smarthome.adapter.MyFragmentPagerAdapter;
import com.wangwanfeng.smarthome.fragment.HomeFragment;
import com.wangwanfeng.smarthome.fragment.JiaFragment;
import com.wangwanfeng.smarthome.fragment.MeFragment;
import com.wangwanfeng.smarthome.fragment.XiaoFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        alFragment.add(jiaFragment);
        alFragment.add(xiaoFragment);
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK
            ...
            if ((System.currentTimeMillis() - exitTime) > 2000) {
                Toast.makeText(MainActivity.this, "再按一次退出家居系统",
